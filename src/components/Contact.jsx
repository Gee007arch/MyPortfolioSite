...
const Contact = () => {
  ...
  return (
    <section
      id="contact"
      className="section-padding bg-theme-off-black text-white relative overflow-hidden"
    >
      ...
      >
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-4 text-theme-paper-white text-shimmer-animate inline-block relative z-10">
            Get In Touch
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <motion.div variants={fadeInUp}>
            <h3 className="text-2xl font-bold mb-8 border-l-4 border-theme-red pl-4">
              Let's Connect
            </h3>
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="group">
                  <label
                    htmlFor="name"
                    className="block text-sm font-semibold mb-2 text-gray-300 group-hover:text-white transition-colors"
                  >
                    Name
                  </label>
                  <input
